...
export default function Header() {
  return (
    <div className="relative">
      <header className="flex justify-between space-x-3 h-15 items-center p-6 bg-muted z-10 fixed top-0 right-0 left-0 border border-b-slate-200 dark:border-b-slate-600">
        ...
        <div className="flex items-center justify-center space-x-2 h-full">
          ...
          <Link
            href="https://www.linkedin.com/in/marcus-valerio/"
            target="_blank"
          >
            <Button
          ...
          <Link href="https://github.com/marcusv02/FilmGraph" target="_blank">
            <Button
              className="hover:cursor-pointer"
              variant="outline"
              size="icon"
